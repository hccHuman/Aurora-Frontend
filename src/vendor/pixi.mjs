...
// PATCH
if(typeof window!=='undefined'){if(!window.PIXI)window.PIXI={};if(!window.PIXI.settings)window.PIXI.settings={};if(!window.PIXI.settings.RETINA_PREFIX)window.PIXI.settings.RETINA_PREFIX=/@2x/;}
